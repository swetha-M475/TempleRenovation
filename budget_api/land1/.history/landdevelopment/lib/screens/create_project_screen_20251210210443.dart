...
class _CreateProjectScreenState extends State<CreateProjectScreen> {
  ...
  // ============ NEW: detect live location and format to DMS ============
  ...
  Future<void> _detectAndFillLocation() async {
    ...
    String dmsFormat = '$latDMS $lngDMS';

    setState(() {
      _mapLocationController.text = dmsFormat;
    });
  }
      ...
      children: [
        CircleAvatar(
          ...
          child: Text(
            '${step + 1}',
            style:
                TextStyle(color: active ? Colors.white : Colors.black45),
          ),
        ),
    ...
    return _buildFormContainer(
      child: Column(
        children: [
          ...
          const SizedBox(height: 16),
          _textField(
              _districtController, 'District', Icons.domain_outlined),
          const SizedBox(height: 16),
          Row(
            children: [
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    labelText:
                        'Map Location (paste from Maps or auto-detect)',
                    hintText:
                        'Paste address/lat,lng OR tap GPS icon to auto-detect your location',
            ...
            children: [
              Expanded(
                  child: _featureButton(
                      'Lingam', Icons.account_balance)),
              const SizedBox(width: 12),
              Expanded(
                  child:
                      _featureButton('Avudai', Icons.architecture)),
            ],
          ),
          const SizedBox(height: 12),
          _featureButton('Nandhi', Icons.pets),
          if (_selectedFeature != null)
            _buildFeatureDetails(_selectedFeature!),
        ],
      ),
    );
  }
