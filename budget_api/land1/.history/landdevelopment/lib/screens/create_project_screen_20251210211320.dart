              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText:
                        'Paste address/lat,lng OR tap GPS icon to auto-detect location',
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _featureButton('Lingam', Icons.account_balance),
              ),
    ...
    return _buildFormContainer(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _textField(_estimatedAmountController,
              'Estimated Amount', Icons.account_balance_wallet,
              keyboard: TextInputType.number),
        ],
      ),
    );
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color:
                isSelected ? const Color(0xFFD4AF37) : Colors.white.withOpacity(0.2),
