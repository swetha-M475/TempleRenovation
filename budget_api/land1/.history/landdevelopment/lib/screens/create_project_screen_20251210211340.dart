              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText:
                      'Tap GPS icon to auto-detect location',
      ...
      children: [
        ...
        if (_type == 'new') ...[
          ...
          ..._predefinedDimensions.map((dim) => Padding(
                ...
                child: _buildDimensionOption(dim['name'], '₹${dim['amount']}', dim['name']),
              )),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(icon, color: selected ? const Color(0xFFD4AF37) : Colors.white70),
            const SizedBox(width: 8),
            Text(
              title,
              style: GoogleFonts.poppins(
