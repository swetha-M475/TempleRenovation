...
class _CreateProjectScreenState extends State<CreateProjectScreen> {
  ...
  // ============ NEW: detect live location and reverse-geocode to address ============
  Future<void> _detectAndFillLocation() async {
    ...
    try {
      ...
      if (placemarks.isNotEmpty) {
        ...
        // No placemark found — fallback to lat,lng
        setState(() {
      ...
      // In case reverse-geocoding fails
      setState(() {
        _mapLocationController.text =
            '${position.latitude}, ${position.longitude}';
      });
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Map Location (paste from Maps or auto)',
                    hintText:
                        '1. Tap map icon  2. Long-press location in Maps  3. Copy address/lat,lng  4. Paste here  \nor  Tap GPS icon to auto-detect your location',
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              title,
              style: GoogleFonts.poppins(
                color: selected ? const Color(0xD4AF37) : Colors.white,
