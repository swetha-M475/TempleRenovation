...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  // Tabs updated with Orange theme
        ...
        child: Row(
          ...
          children: [
            Icon(
              icon,
              size: 18,
              color: isActive ? const Color(0xFFF57C00) : Colors.white,
            ),
            const SizedBox(width: 8),
            Text(
              label,
  ...
  // Notifications drawer with Orange theme
        ...
        child: Row(
          children: [
            Container(
              ...
              height: 8,
              decoration: BoxDecoration(
                color: read ? Colors.grey : const Color(0xFFF57C00),
                shape: BoxShape.circle,
              ),
            ),
      ...
      builder: (context) => SafeArea(
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading: const Icon(Icons.person_outline, color: Color(0xFFF57C00)),
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('Close', style: TextStyle(color: Color(0xFFF57C00))),
          ),
        ],
      ),
    );
