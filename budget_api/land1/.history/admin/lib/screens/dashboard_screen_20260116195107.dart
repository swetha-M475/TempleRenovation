...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  bool _isValidDistrict(String name) {
    ...
    // List of unwanted names you mentioned
    const unwanted = {'district3', 'sample', 'dis2', 'new1', 'test', 'null', 'undefined'};
  ...
  void _sortDistricts(List<Map<String, dynamic>> list) {
    list.sort((a, b) {
      ...
      // 2. Secondary: If both have requests or both have 0, sort alphabetically
  ...
  // Real-time Stream for Projects/Districts
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        for (var doc in docs) {
          ...
          // Firebase Cleanup for unwanted names
  ...
  void _showAdminMenu() {/* Implement menu UI similar to previous version if needed */}
}