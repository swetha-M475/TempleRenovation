  ...
  Future<void> _loadPlaces() async {
    ...
    try {
      ...
      for (final doc in snapshot.docs) {
        ...
        // In this app logic, "pending" means not yet sanctioned
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Search Section with Soft Parchment and Gold Border
          Padding(
            padding: const EdgeInsets.all(16),
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: const TextStyle(color: darkMaroonText),
            ...
            child: isLoading
                ...
                : filtered.isEmpty
                    ? const Center(
                        child: Text(
                          'No taluks available',
                          style: TextStyle(color: darkMaroonText),
                        ),
                      )
                    : ListView.builder(
