...
class _DistrictPlacesScreenState extends State<DistrictPlacesScreen> {
  ...
  Future<void> _loadPlaces() async {
    ...
    try {
      ...
      for (final doc in snapshot.docs) {
        ...
        final String status = isSanctioned ? 'sanctioned' : 'pending';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  // Row for Back Button and Aligning with Title
                  Row(
                    children: [
                      IconButton(
          ...
          // Search Section (Better Spacing)
          transformSearchSection(),
            ...
            child: isLoading
                ...
                : filtered.isEmpty
                    ? const Center(
                        child: Text(
                          'No taluks available',
                          style: TextStyle(color: darkMaroonText, fontSize: 16),
                        ),
                      )
                    : ListView.builder(
  ...
  Widget transformSearchSection() {
    return Padding(
      padding: const EdgeInsets.all(16),
      child: TextField(
        onChanged: (v) => setState(() => searchQuery = v),
        decoration: InputDecoration(
          hintText: 'Search taluks in $districtName...',
          ...
          enabledBorder: OutlineInputBorder(
            ...
            borderSide: const BorderSide(color: secondaryGold, width: 1),
          ),
  ...
  Widget _buildTalukCard(Map<String, dynamic> place) {
    return Card(
      elevation: 2,
      shadowColor: primaryMaroon.withOpacity(0.1),
      color: Colors.white,
      ...
      child: ListTile(
        ...
        subtitle: Padding(
          ...
          child: Text(
            '${place['temples']} Project${place['temples'] == 1 ? '' : 's'}',
            style: TextStyle(color: darkMaroonText.withOpacity(0.6), fontSize: 14),
          ),
        ),
        trailing: Row(
          ...
          children: [
            ...
            const Icon(Icons.chevron_right, color: primaryAccentGold, size: 28),
          ],
        ),
      ),
    );
