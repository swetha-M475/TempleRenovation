...
class PendingTempleDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Fixed: Replaced WillPopScope with PopScope
    return PopScope(
      canPop: false, // Prevent default pop to run our custom logic
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0xFF6A1F1A), Color(0xFF8E3D2C)],
        ),
  ...
  // Cards & Info Rows (CustomCard logic preserved)
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return ClipRRect(
                    ...
                    child: Image.network(siteImages[index], width: 240, fit: BoxFit.cover),
                  );
                },
              ),
            ),
  ...
  void _handleAction(BuildContext context, bool isSanction) async {
    ...
    if (confirm == true) {
      try {
        ...
        // Handle potential Firebase errors here
        if (context.mounted) {
