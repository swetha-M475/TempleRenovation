...
class FirebaseService {
  ...
  static Future<List<Map<String, dynamic>>> getPlacesByDistrict(String districtId) async {
  ...
  // TEMPLES / PROJECTS
  // --------------------------------------------------------
  static Future<List<Map<String, dynamic>>> getTemplesByPlace(String placeId) async {
    final snapshot = await _db
        .collection('projects')
