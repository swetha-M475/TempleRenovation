          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (statusTab == 0) current = pending.toList();
                else if (statusTab == 1) current = approved.toList();
                else current = rejected.toList();
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border:
                  Border.all(color: active ? Colors.white : Colors.white30)),
          child: Text(label,
        ...
        child: Padding(
          ...
          child: Column(
              ...
              children: [
                ...
                Text("Amount: ₹${data['estimatedAmount']}",
                    style: const TextStyle(
