    ...
    try {
      ...
      if (!input.contains('@')) {
        try {
          ...
          _showError(
              'Database error: Make sure Firestore rules allow reading.');
          setState(() => _isLoading = false);
          return;
        }
      }
      ...
      // 4. Navigation
      // If you are using AuthGate in main.dart, you don't strictly need this,
      // but if you want to force WelcomeScreen:
      if (mounted) {
        Navigator.pushReplacement(
          context,
      ...
      // Specifically catch Firebase Auth errors
