...
class _SignupScreenState extends State<SignupScreen> {
  ...
  // Replace with your actual 2Factor API Key
  ...
  Future<void> _signup() async {
    ...
    if (!_otpVerified) {
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Please verify your phone number via OTP")));
      return;
    }
                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                              ...
                              _input(_username, "Choose Username",
  ...
  Widget _input(TextEditingController c, String lbl, IconData ic,
    ...
    return TextFormField(
      ...
      decoration: _fieldDecoration(lbl, ic).copyWith(
