...
class _SignupScreenState extends State<SignupScreen> {
  ...
  bool _isValid(String type, String value) {
    ...
    switch (type) {
      case "name":
        return value.length >= 3 && RegExp(r'^[a-z A-Z]+$').hasMatch(value);
      case "username":
        return value.length >= 4 &&
            _usernameError == null &&
            !_checkingUsername;
      case "phone":
        return value.length == 10 && _phoneError == null && !_checkingPhone;
      case "aadhar":
        return value.length == 12 && _aadharError == null && !_checkingAadhar;
      case "password":
        return value.length >= 6;
      case "confirm":
        return value == _password.text && value.isNotEmpty;
      case "required":
  ...
  Widget _buildLogo() {
    return Container(
      ...
      child: Padding(
          ...
          child: ClipOval(
              child:
                  Image.asset('assets/images/shiva.png', fit: BoxFit.cover))),
    );
  }
              ...
              Expanded(
                child: TextFormField(
                  ...
                  decoration: _fieldDecoration(
                          ...
                          isValid: _isValid("phone", _phone.text))
                      .copyWith(
                    counterText: "",
  ...
  InputDecoration _fieldDecoration(String lbl, IconData ic,
      {bool isValid = false, bool isLoading = false}) {
  ...
  Widget _input(TextEditingController c, String lbl, IconData ic,
    ...
    return TextFormField(
        ...
        decoration: _fieldDecoration(lbl, ic,
            isValid: _isValid(validationType ?? "", c.text),
            isLoading: isLoading),
        onChanged: (v) {
        ...
        validator: (v) {
          ...
          if (validationType == "name" &&
              (v.length < 3 || !RegExp(r'^[a-z A-Z]+$').hasMatch(v)))
            return "Enter a valid name (min 3 chars)";
          if (validationType == "username") {
  ...
  Widget _passwordField(TextEditingController c, String lbl,
    ...
    return TextFormField(
        ...
        decoration: _fieldDecoration(lbl, Icons.lock_outline,
            isValid: isConfirm
                ? _isValid("confirm", c.text)
                : _isValid("password", c.text)),
    ...
    return Row(children: [
      SizedBox(
          ...
          child: Checkbox(
              ...
              side: BorderSide(color: _mutedBronze),
