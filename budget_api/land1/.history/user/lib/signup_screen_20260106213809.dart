...
class _SignupScreenState extends State<SignupScreen> {
    ...
    try {
      ...
      if (res.statusCode == 200 && data["Status"] == "Success") {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Sending OTP via $_selectedMethod..."))
        );
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Error: ${data["Details"] ?? "Failed to send"}"))
        );
      }
    } catch (e) {
  ...
  Future<void> _verifyOtp() async {
    ...
    // Verification is the same for both methods
  ...
  Future<void> _signup() async {
    ...
    if (!_otpVerified) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Please verify your number")));
      return;
    }
    if (!_agree) {
                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                              ...
                              const SizedBox(height: 16),
                              _phoneSection(), // MULTI-METHOD PHONE SECTION
                              const SizedBox(height: 16),
