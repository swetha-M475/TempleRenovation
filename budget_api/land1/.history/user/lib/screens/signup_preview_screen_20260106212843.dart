...
class _SignupPreviewScreenState extends State<SignupPreviewScreen> {
  // Color Palette from your template
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(child: _methodTile("SMS", Icons.sms_outlined)),
                    const SizedBox(width: 15),
                    Expanded(child: _methodTile("Phone", Icons.phone_callback_rounded)),
                  ],
                ),
                // ------------------------------
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(title,
              style: GoogleFonts.poppins(
                  fontSize: 12, color: creamyGoldText.withOpacity(0.7))),
