        ...
        return ListView.builder(
          ...
          itemBuilder: (context, i) => Card(
            ...
            shape: RoundedRectangleBorder(
              ...
              side: BorderSide(color: primaryGold.withOpacity(0.3)), // FIXED HERE
            ),
            child: ListTile(
              title: Text('₹${docs[i].data()['amount']}', style: const TextStyle(fontWeight: FontWeight.bold, color: darkMaroonText)),
      ...
      children: [
        ...
        Padding(
          ...
          child: ElevatedButton.icon(
            ...
            label: const Text("UPLOAD NEW BILL", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
            style: ElevatedButton.styleFrom(backgroundColor: primaryMaroon, minimumSize: const Size(double.infinity, 45)),
          ),
        ),
        Expanded(
            ...
            itemBuilder: (context, i) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Text("₹${bill['amount']} • ${bill['date'].day}/${bill['date'].month}/${bill['date'].year}"),
                  trailing: const Icon(Icons.receipt, color: primaryGold),
                ),
              );
            },
          ),
                ...
                itemBuilder: (context, i) {
                  ...
                  return Align(
                    ...
                    child: Container(
                      ...
                      child: Text(data['message'] ?? '', style: TextStyle(color: isMe ? Colors.white : Colors.black)),
                    ),
                  );
                },
              );
      ...
      child: Row(
        children: [
          ...
          CircleAvatar(
            ...
            child: IconButton(icon: const Icon(Icons.send, color: Colors.white, size: 18), onPressed: _sendFeedback),
          )
        ],
      ),
    );
        ...
        content: StatefulBuilder(builder: (context, setS) => Column(
          ...
          children: [
            ...
            TextButton(onPressed: () async {
              ...
              if(picked != null) setS(() => images = picked);
            }, child: Text("Select Images (${images.length})")),
          ],
        )),
        actions: [
          ElevatedButton(onPressed: () async {
            ...
            await _firestore.collection('bills').add({
              'projectId': _projectId, 'userId': _userId, 'title': titleCtrl.text, 'amount': amtCtrl.text, 'imageUrls': urls, 'createdAt': now
            });
            _restoreData();
        ...
        child: Column(
          children: [
              ...
              child: Row(
                children: [
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text(widget.project['place'] ?? '', style: GoogleFonts.poppins(color: primaryGold, fontSize: 14)),
                  ]),
                ],
              ),
            ),
            TabBar(
              ...
              indicatorColor: primaryGold, indicatorWeight: 3,
