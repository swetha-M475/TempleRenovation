                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text("No transaction requests found",
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text("Requested: ${_formatTimestamp(date)}"),
                      ...
                      onTap: () {
                        // Optional: Show detail dialog for QR or UPI ID
                        _showTransactionDetail(data);
                      },
                    ),
                  );
                },
    ...
    showModalBottomSheet(
      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(data['title'] ?? 'Request Detail', style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.bold, color: primaryMaroon)),
            const Divider(),
            const SizedBox(height: 10),
            Text("Amount: ₹${data['amount']}", style: const TextStyle(fontSize: 16)),
            Text("UPI ID: ${data['upiId'] ?? 'N/A'}", style: const TextStyle(fontSize: 16)),
            ...
            if (data['qrUrl'] != null) ...[
              ...
              GestureDetector(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(8),
                  child: Image.network(data['qrUrl'], height: 150, width: 150, fit: BoxFit.cover),
                ),
              ),
            ],
            const SizedBox(height: 20),
            ...
            SliverToBoxAdapter(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.project['title'] ?? 'Project Overview',
                      style: GoogleFonts.poppins(
                        fontSize: 22,
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                    ...
                    Text(
                      "Client: ${widget.project['clientName'] ?? 'N/A'}",
        ...
        child: Column(
          children: [
            ListTile(
              ...
              subtitle: Text(widget.dateDisplay),
              trailing: _isUploading
                  ? const CircularProgressIndicator()
                  : ElevatedButton(
                      onPressed: isPending ? null : _completeTask,
                      style: ElevatedButton.styleFrom(
