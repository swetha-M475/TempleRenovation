...
class _ProjectOverviewScreenState extends State<ProjectOverviewScreen>
  ...
  // Helper to check if deletion is allowed (within 1 hour)
  bool _isWithinDeleteTime(dynamic createdAt) {
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, i) {
                  final billData = docs[i].data();
                  final billId = docs[i].id;
                  final createdAt = billData['createdAt'];
                  final bool showDelete = _isWithinDeleteTime(createdAt);
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(billData['title'] ?? 'Bill',
                                    style: GoogleFonts.poppins(
                          ...
                          if (billData['imageUrls'] != null &&
                              (billData['imageUrls'] as List).isNotEmpty)
                            SizedBox(
                              height: 80,
                              child: ListView(
                                scrollDirection: Axis.horizontal,
                                children: (billData['imageUrls'] as List)
