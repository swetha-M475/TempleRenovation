...
import 'splash_screen.dart'; // Ensure this import is correct for your project
  ...
  Future<void> _logout() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Text('Sign Out',
            style: GoogleFonts.cinzel(fontWeight: FontWeight.bold, color: deepDeepRed)),
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: deepDeepRed),
            child: Text('LOGOUT', style: GoogleFonts.poppins(color: primaryGold)),
          ),
        ],
      ),
    );
