...
class _ProjectOverviewScreenState extends State<ProjectOverviewScreen>
  ...
  Future<void> _deleteBill(String docId) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Bill deleted for all users')));
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  // --- BILLS TAB (FIXED: Pulls from Firestore + Delete Option) ---
  Widget _billsTab() {
    return Column(
      children: [
        const SizedBox(height: 16),
          ...
          child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                return Center(child: Text('No bills found', style: GoogleFonts.poppins(color: Colors.grey)));
              }
