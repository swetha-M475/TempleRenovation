...
class _SignupScreenState extends State<SignupScreen> {
  ...
  void initState() {
    ...
    // Modified Phone Listener: Check as soon as 10 digits are reached or focus lost
  ...
  Future<void> _sendOTP() async {
    // Critical Fix: Double check phone error before sending
        ...
        if (!_otpVerified)
          Row(
            ...
            children: [
              ...
              // ONLY SHOW OTP BUTTON IF PHONE IS VALID AND NOT A DUPLICATE
