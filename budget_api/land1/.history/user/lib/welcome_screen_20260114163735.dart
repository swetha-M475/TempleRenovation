...
class _WelcomeScreenState extends State<WelcomeScreen> {
  ...
  Widget _projectSection() {
    ...
    // FETCH UNIQUE ID FROM DATA
    String displayId = _project!['projectId'] ?? "ID-PENDING";
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text(
                  (_project!['status'] ?? 'Pending').toString().toUpperCase(),
                  style: GoogleFonts.poppins(
                    fontSize: 12,
                    fontWeight: FontWeight.bold,
                    color: _project!['status'] == 'approved' ? Colors.green : Colors.orange,
                  ),
                ),
              ],
            ),
