...
class _WelcomeScreenState extends State<WelcomeScreen> {
  ...
  void _navigateToCreateProject() async {
    ...
    // No need to call load again because the StreamBuilder will catch the new doc
  }
  ...
  /// Delete function for the User to withdraw a pending plan
  Future<void> _deleteProject(String projectId) async {
    ...
    if (confirm == true) {
      // Deleting this will trigger the StreamBuilder to update the UI automatically
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Pass the logic to the button via Stream check
  ...
  /// This widget handles the real-time updates for projects
  Widget _buildProjectLogicSection() {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        return Column(
          children: [
            _createProjectButton(hasProject),
            ...
            if (hasProject)
              ...
              const Center(
                child: Padding(
                  ...
                  child: Text("No plans proposed yet.",
  ...
  Widget _createProjectButton(bool hasProject) {
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor:
              hasProject ? Colors.grey[400] : const Color(0xFF5D4037),
  ...
  Widget _projectSection(Map<String, dynamic> project) {
    ...
    final Color statusColor =
        isApproved ? Colors.green.shade700 : Colors.orange.shade800;
    final Color bgColor =
              ...
              children: [
                Text(
                  ...
                  style: GoogleFonts.poppins(
                      ...
                      fontStyle:
                          isApproved ? FontStyle.normal : FontStyle.italic),
                ),
                if (status == 'pending')
                  IconButton(
