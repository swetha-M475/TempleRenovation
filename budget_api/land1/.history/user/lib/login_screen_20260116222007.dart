...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // This controller handles either the username or the phone number
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (isPhone) {
        // Look up the username linked to this phone number
        ...
        // 2. TREAT AS USERNAME
        // Directly append virtual domain
      ...
      if (e.code == 'user-not-found' || e.code == 'invalid-credential') {
        msg = "Invalid username/phone or password.";
