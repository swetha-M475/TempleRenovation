...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Widget _input(TextEditingController c, String lbl, IconData ic, {TextInputType keyboardType = TextInputType.text, String? validationType}) {
    return TextFormField(
      ...
      validator: (v) {
        ...
        if (validationType == "name") {
          ...
          if (!RegExp(r'^[a-z A-Z]+$').hasMatch(v)) return "Alphabets only";
        }
        
        if (validationType == "username") {
          if (v.length < 4) return "Username too short";
